...
def donation_options():
    ...
    amount1 = st.number_input("How many sanitary products do you want to donate?")
    amount2 = st.number_input("How many housing goods do you want to donate?")
    amount3 = st.number_input("How many clothes/blankets do you want to donate?")
    amount4 = st.number_input("How many sleeping mats do you want to donate?")
    amount5 = st.number_input("Do you want to donate money, if so: Insert your amount in €")
...
# dont forget to comment this out donation_options()